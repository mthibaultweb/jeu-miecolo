class Scene8 extends Phaser.Scene {
    ...
    create() {
        ...
        const text1 = new Text(50, 50, 0, 0, 'Voyons voir comment nos abeilles vont', this);
        const text2 = new Text(50, 80, 0, 0, 'se débrouiller pour régler ce problème !', this);

        const button = new Button(40, 500, 0, 0, 'C\'est parti !', this, () => this.scene.start("sceneNine"));
    }
}